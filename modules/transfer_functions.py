...
def integrate_1_tf(raw_data,previous_acc,mouse_pos):
	new_acc = (-raw_data[0]/1.5,raw_data[1]/1.5)
	prev_acc = (-previous_acc[0]/1.5,previous_acc[1]/1.5)

	mouse_pos_x, mouse_pos_y = trapezoidal_integrate(mouse_pos,new_acc,prev_acc)
...
def integrate_2_tf(raw_data,previous_acc,previous_vel,mouse_pos):
	...
	mouse_vel_x,mouse_vel_y = trapezoidal_integrate(prev_vel,new_acc,prev_acc,0.1)

	new_vel = (mouse_vel_x, mouse_vel_y)
	mouse_pos_x, mouse_pos_y = trapezoidal_integrate(mouse_pos,new_vel,prev_vel,0.1)
